    ...
    <div class="main-container">
        <div class="content">
            ...
            <form action="update_profile.php" method="post">
                ...
                <input type="text" id="mobile" name="mobile" value="<?php echo htmlspecialchars($profile['mobile']); ?>" required>

                <label for="address">Address:</label>
                <textarea id="address" name="address" required><?php echo htmlspecialchars($profile['address']); ?></textarea>

                <label for="country">Country:</label>
                <input type="text" id="country" name="country" value="<?php echo htmlspecialchars($profile['country']); ?>" required>
